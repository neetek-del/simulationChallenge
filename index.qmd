...
# --- Plot ---
fig, ax = plt.subplots(figsize=(8, 5))  # compact size for GitHub/Quarto
...
```{python}
#| label: q3-final-distribution-linear
#| fig-cap: "Distribution of Final Balances Across 100 Simulations (Linear Scale)"
#| echo: true
